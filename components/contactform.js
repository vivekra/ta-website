    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex min-h-screen justify-center items-center w-full">
          <div className="flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-6 bg-[#00519d] w-full max-w-4xl p-8 rounded-xl shadow-lg text-white">
            <div className="flex flex-col space-y-8 justify-between">
              <div>
                <h1 class="font-bold text-4xl tracking-wide">Contact Us </h1>
                <p className="pt-2 text-sky-50 text-sm">
                  Thank you for visiting our web site. Your feedback is important to us in order to provide the very best service possible.
                </p>
              </div>
              <div className="flex flex-col space-y-6">
                <div className="inline-flex space-x-2 items-center">

                  <span>+44 7424 791288</span>
                </div>

                <div className="inline-flex space-x-2 items-center">

                  <span>cloudcas@arima.io</span>
                </div>


                <div className="inline-flex space-x-2 items-center text-sm">

                  <span>#23, Cholan Street, Myilarasu Nagar, Chrompet, Chennai - 600 044. India</span>
                </div>

                <div className="flex mt-5 space-x-4 text-sky-100 dark:text-gray-500">
                  <a
